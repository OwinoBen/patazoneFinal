define(['./jquery', './ajaxsuite-popup', './validation'], function ($, ajaxsuitepopup) {
    'use strict';
    $.widget('rokanthemes.ajaxsuite', {
        options: {
            ...
            ajaxCart: {
                ...
                initConfig: {'show_success_message': true, 'timerErrorMessage': 3000, 'addWishlistItemUrl': null},
                formKey: null,
            ...
            ajaxCompare: {enabled: 0, compareSelector: '.tocompare', CompareUrl: null,},
            quickView: {enabled: 0},
            ...
            this._bind();
            this.options.popupWrapper = $('<div />', {'id': 'mb-ajaxsuite-popup-wrapper'}).appendTo($('#ajaxsuite-popup-content'));
            ...
            $(document).on('ajaxComplete', function (event, xhr, settings) {
                if (settings.type.match(/get/i) && settings.url.match(/customer\/section\/load/i) && _.isObject(xhr.responseJSON) && xhr.responseJSON.cart) {
