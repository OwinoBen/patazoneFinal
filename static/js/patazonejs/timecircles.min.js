!function (t) {
    ...
    function s(t) {
        ...
        if (null !== e && e.length > 0) {
            var a = t.split(" "), i = a[0].split("-"), n = a[1].split(":");
    ...
    function h(t) {
        ...
        t.requestAnimationFrame && t.cancelAnimationFrame || (t.requestAnimationFrame = function (e, a, i) {
            "undefined" == typeof i && (i = {data: {last_frame: 0}});
            var n = (new Date).getTime(), s = Math.max(0, 16 - (n - i.data.last_frame)), r = t.setTimeout(function () {
                e(n + s)
            }, s);
    ...
    Object.keys || (Object.keys = function () {
        ...
        return function (n) {
            ...
            if (e) for (r = 0; i > r; r++) t.call(n, a[r]) && o.push(a[r]);
            return o
        }
    }());
    var u = !1, l = 200, f = ("#debug" === location.hash, ["Days", "Hours", "Minutes", "Seconds"]),
    ...
    Array.prototype.indexOf || (Array.prototype.indexOf = function (t) {
        var e = this.length >>> 0, a = Number(arguments[1]) || 0;
        for (a = 0 > a ? Math.ceil(a) : Math.floor(a), 0 > a && (a += e); e > a; a++) if (a in this && this[a] === t) return a;
        return -1
    });
    ...
    _.prototype.clearListeners = function () {
        ...
        var s = this.element.offsetHeight, r = this.element.offsetWidth;
        ...
        if ("undefined" == typeof t) t = !1; else if (t && this.data.paused) return;
        ...
        if (this.data.prev_time = n, null === i && (i = n), !this.config.count_past_zero && n > this.data.attributes.ref_date) {
            for (var s = 0; s < this.data.drawn_units.length; s++) {
                ...
                var h = s * this.data.attributes.item_size + this.data.attributes.item_size / 2,
                    c = this.data.attributes.item_size / 2, p = this.config.time[o].color;
                this.drawArc(h, c, p, 0)
            }
            return void this.stop()
        }
        e = (this.data.attributes.ref_date - n) / 1e3, a = (this.data.attributes.ref_date - i) / 1e3;
        var _ = "smooth" !== this.config.animation, b = r(e, a, this.data.total_duration, this.data.drawn_units, _),
            g = r(e, a, m.Years, f, _), s = 0, v = 0, y = null, w = this.data.drawn_units.slice();
        for (var s in f) {
            var o = f[s];
        ...
        if (null !== this.data.attributes.context) {
            var r = n - i;
            if (Math.abs(r) > .5) 0 === i ? this.radialFade(t, e, a, 1) : this.radialFade(t, e, a, 0); else {
        ...
        for (r = 0; 1 >= n && n >= 0; r++) !function () {
            var e = 50 * r, i = "rgba(" + o.r + ", " + o.g + ", " + o.b + ", " + Math.round(10 * n) / 10 + ")";
        ...
        if ("undefined" == typeof e && (e = t(this.element).attr("data-date")), "string" == typeof e) this.data.attributes.ref_date = s(e); else if ("number" == typeof this.data.timer) this.data.paused && (this.data.attributes.ref_date = (new Date).getTime() + 1e3 * this.data.timer); else {
    ...
    b.prototype.getInstance = function (e) {
        ...
        if ("undefined" == typeof i && (i = n(), t(e).attr("data-tc-id", i)), "undefined" == typeof p[i]) {
            var s = this.options, r = t(e).data("options");
