define(['jquery', 'rokanthemes/lazyloadimg', 'rokanthemes/owl', 'rokanthemes/marquee', 'rokanthemes/jquery_sameminheight',], function ($, lazy) {
    'use strict';
    $('body').on('contentUpdated', function (event, id) {
        ...
        if (owl.hasClass('owl-loaded')) {
            ...
            owl.each(function (index, el) {
                ...
                var $bigdesk_items = $_this.data('bigdesktop') ? $_this.data('bigdesktop') : $item ? $item : 4;
                var $desksmall_items = $_this.data('smalldesktop') ? $_this.data('smalldesktop') : $item ? $item : 3;
                ...
                var $tabletsmall_items = $_this.data('smalltablet') ? $_this.data('smalltablet') : $item ? $item : 2;
                ...
                var $autoplayTimeout = $_this.data('autoplaytimeout') ? $_this.data('autoplaytimeout') : 5000;
                ...
                $_this.owlCarousel({
                    ...
                    responsive: {
                        0: {items: $mobile_items, margin: $mobile_margin},
                        576: {items: $tabletsmall_items, margin: $mobile_margin},
                        768: {items: $tablet_items, margin: $tablet_margin},
                        992: {items: $bigtablet_items, margin: $tablet_margin},
                        1024: {items: $desksmall_items, margin: $margin},
                        1200: {items: $default_items, margin: $margin},
                        1550: {items: $bigdesk_items, margin: $margin},
                    }
                });
