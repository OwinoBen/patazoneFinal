...
(function () {
    var DEBUG = true;
    (function (undefined) {
        var window = this || (0, eval)('this'), document = window['document'], navigator = window['navigator'],
            jQueryInstance = window["jQuery"], JSON = window["JSON"];
        (function (factory) {
            ...
            ko.options = {'deferUpdates': false, 'useOnlyNativeEvents': false};
            ko.utils = (function () {
                ...
                return {
                    ...
                    registerEventHandler: function (element, eventType, handler) {
                        ...
                        if (!ko.options['useOnlyNativeEvents'] && !mustUseAttachEvent && jQueryInstance) {
                            ...
                            element.addEventListener(eventType, wrappedHandler, false); else if (typeof element.attachEvent != "undefined") {
            ...
            (function () {
                var none = [0, "", ""], table = [1, "<table>", "</table>"],
                    tbody = [2, "<table><tbody>", "</tbody></table>"],
                    tr = [3, "<table><tbody><tr>", "</tr></tbody></table>"],
                    select = [1, "<select multiple='multiple'>", "</select>"], lookup = {
                        'thead': table,
                        'tbody': table,
                        'tfoot': table,
                        'tr': tbody,
                ...
                function simpleHtmlParse(html, documentContext) {
                    ...
                    var tags = ko.utils.stringTrim(html).toLowerCase(), div = documentContext.createElement("div"),
                        wrap = getWrap(tags), depth = wrap[0];
            ...
            ko.tasks = (function () {
                ...
                var tasks = {
                    'scheduler': scheduler, schedule: function (func) {
                        if (!taskQueueLength) {
            ...
            ko.extenders = {
                'throttle': function (target, timeout) {
                    ...
                    return ko.dependentObservable({
                        'read': target, 'write': function (value) {
            ...
            var ko_subscribable_fn = {
                init: function (instance) {
                    ...
                    var self = this, selfIsObservable = ko.isObservable(self), ignoreBeforeChange, notifyNextChange,
                        previousValue, pendingValue, beforeChange = 'beforeChange';
            ...
            ko.computedContext = ko.dependencyDetection = (function () {
                ...
                return {
                    begin: begin, end: end, registerDependency: function (subscribable) {
                        if (currentFrame) {
            ...
            var observableFn = {
                'equalityComparer': valuesArePrimitiveAndEqual, peek: function () {
            ...
            ko.extenders['trackArrayChanges'] = function (target, options) {
                ...
                var trackingChanges = false, cachedDiff = null, arrayChangeSubscription, pendingNotifications = 0,
                    ...
                    switch (operationName) {
                        ...
                        case'splice':
                            var startIndex = Math.min(Math.max(0, args[0] < 0 ? arrayLength + args[0] : args[0]), arrayLength),
                                ...
                                endIndex = Math.max(endDeleteIndex, endAddIndex), additions = [], deletions = [];
            ...
            var computedFn = {
                "equalityComparer": valuesArePrimitiveAndEqual, getDependenciesCount: function () {
                    ...
                    if (target._deferUpdates && !this[computedState].disposeWhenNodeIsRemoved) {
                        ...
                        return {
                            _target: target, dispose: function () {
                                dirtySub.dispose();
                                changeSub.dispose();
                            }
                        };
                    ...
                    var computedObservable = this, state = computedObservable[computedState],
                        disposeWhen = state.disposeWhen, changed = false;
            ...
            (function () {
                ...
                function objectLookup() {
                    ...
                    constructor: objectLookup, save: function (key, value) {
                        var existingIndex = ko.utils.arrayIndexOf(this.keys, key);
                        if (existingIndex >= 0)
                            this.values[existingIndex] = value; else {
                            this.keys.push(key);
            ...
            ko.expressionRewriting = (function () {
                ...
                var stringDouble = '"(?:[^"\\\\]|\\\\.)*"', stringSingle = "'(?:[^'\\\\]|\\\\.)*'",
                    stringRegexp = '/(?:[^/\\\\]|\\\\.)*/\w*', specials = ',"\'{}()/:[\\]',
                    everyThingElse = '[^\\s:,/][^' + specials + ']*[^\\s' + specials + ']', oneNotSpace = '[^\\s]',
            ...
            (function () {
                ...
                ko.virtualElements = {
                    allowedBindings: {}, childNodes: function (node) {
                        ...
                        if (node.nextSibling && isEndComment(node.nextSibling))
                            return null;
                        return node.nextSibling;
                    }, hasBindingValue: isStartComment, virtualNodeBindingValue: function (node) {
            ...
            (function () {
                ko.bindingHandlers = {};
                var bindingDoesNotRecurseIntoElementTypes = {'script': true, 'textarea': true, 'template': true};
                ...
                function applyBindingsToDescendantsInternal(bindingContext, elementOrVirtualElement, bindingContextsMayDifferFromDomParentElement) {
                    var currentChild, nextInQueue = ko.virtualElements.firstChild(elementOrVirtualElement),
                        provider = ko.bindingProvider['instance'], preprocessNode = provider['preprocessNode'];
                    if (preprocessNode) {
            ...
            (function () {
                ko.bindingHandlers['checked'] = {
                    'after': ['value', 'attr'], 'init': function (element, valueAccessor, allBindings) {
            ...
            function makeWithIfBinding(bindingKey, isWith, isNot, makeContextCallback) {
                ko.bindingHandlers[bindingKey] = {
                    'init': function (element, valueAccessor, allBindings, viewModel, bindingContext) {
                        ...
                        ko.computed(function () {
                            var rawValue = valueAccessor(), dataValue = ko.utils.unwrapObservable(rawValue),
                                shouldDisplay = !isNot !== !dataValue, isFirstRender = !savedNodes,
            ...
            ko.bindingHandlers['options'] = {
                'init': function (element) {
                    ...
                    var selectWasPreviouslyEmpty = element.length == 0, multiple = element.multiple,
                        previousScrollTop = (!selectWasPreviouslyEmpty && multiple) ? element.scrollTop : null,
                        unwrappedArray = ko.utils.unwrapObservable(valueAccessor()),
                        valueAllowUnset = allBindings.get('valueAllowUnset') && allBindings['has']('value'),
                        includeDestroyed = allBindings.get('optionsIncludeDestroyed'),
                        arrayToDomNodeChildrenOptions = {}, captionValue, filteredArray, previousSelectedValues = [];
                    if (!valueAllowUnset) {
                        if (multiple) {
            ...
            ko.bindingHandlers['selectedOptions'] = {
                'after': ['options', 'foreach'], 'init': function (element, valueAccessor, allBindings) {
            ...
            (function () {
                ...
                function activateBindingsOnContinuousNodeArray(continuousNodeArray, bindingContext) {
                    if (continuousNodeArray.length) {
                        var firstNode = continuousNodeArray[0],
                            ...
                            parentNode = firstNode.parentNode, provider = ko.bindingProvider['instance'],
                ...
                ko.bindingHandlers['template'] = {
                    'init': function (element, valueAccessor) {
                        ...
                        var value = valueAccessor(), options = ko.utils.unwrapObservable(value), shouldDisplay = true,
                            templateComputed = null, templateName;
            ...
            ko.utils.compareArrays = (function () {
                ...
                function compareSmallArrayToBigArray(smlArray, bigArray, statusNotInSml, statusNotInBig, options) {
                    var myMin = Math.min, myMax = Math.max, editDistanceMatrix = [], smlIndex,
                        smlIndexMax = smlArray.length, bigIndex, bigIndexMax = bigArray.length,
                        compareRange = (bigIndexMax - smlIndexMax) || 1, maxDistance = smlIndexMax + bigIndexMax + 1,
                    ...
                    for (smlIndex = 0; smlIndex <= smlIndexMax; smlIndex++) {
                        ...
                        for (bigIndex = bigIndexMinForRow; bigIndex <= bigIndexMaxForRow; bigIndex++) {
                            if (!bigIndex)
                                ...
                                thisRow[bigIndex] = lastRow[bigIndex - 1]; else {
