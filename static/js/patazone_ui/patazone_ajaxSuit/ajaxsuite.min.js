define(['jquery', 'mage/translate', 'Magento_Customer/js/customer-data', 'Rokanthemes_AjaxSuite/js/model/ajaxsuite-popup', 'mage/validation/validation'], function($, $t, customerData, ajaxsuitepopup) {
    'use strict';
