...
;(function () {
    var ctx = require.s.contexts._, origNameToUrl = ctx.nameToUrl, baseUrl = ctx.config.baseUrl;
...
;define('mixins', ['module'], function (module) {
    'use strict';
    var contexts = require.s.contexts, defContextName = '_', defContext = contexts[defContextName],
        unbundledContext = require.s.newContext('$'), defaultConfig = defContext.config, unbundledConfig = {
    ...
    function removeBaseUrl(url, config) {
        var baseUrl = config.baseUrl || '', index = url.indexOf(baseUrl);
        if (~index) {
    ...
    rjsMixins = {
        load: function (name, req, onLoad, config) {
            var path = getPath(name, config), mixins = this.getMixins(path), deps = [name].concat(mixins);
            req(deps, function () {
...
require(['mixins'], function (mixins) {
    'use strict';
    var contexts = require.s.contexts, defContextName = '_', defContext = contexts[defContextName],
        originalContextRequire = defContext.require, processNames = mixins.processNames;
    ...
    defContext.defQueue.shift = function () {
        var queueItem = Array.prototype.shift.call(this), lastDeps = queueItem && queueItem[1];
...
;(function (require) {
    ...
    (function () {
        var config = {
            ...
            config: {
                mixins: {
                    'Magento_Theme/js/view/breadcrumbs': {'Magento_Theme/js/view/add-home-breadcrumb': true},
    ...
    (function () {
        var config = {
            map: {'*': {configurable: 'Magento_ConfigurableProduct/js/configurable'}},
            config: {mixins: {'Magento_Catalog/js/catalog-add-to-cart': {'Magento_ConfigurableProduct/js/catalog-add-to-cart-mixin': true}}}
        };
        require.config(config);
    })();
    (function () {
        var config = {
            map: {'*': {configurableVariationQty: 'Magento_InventoryConfigurableProductFrontendUi/js/configurable-variation-qty'}},
            config: {mixins: {'Magento_ConfigurableProduct/js/configurable': {'Magento_InventoryConfigurableProductFrontendUi/js/configurable': true}}}
        };
        require.config(config);
    })();
    (function () {
    ...
    (function () {
        var config = {config: {mixins: {'Magento_Swatches/js/swatch-renderer': {'Magento_InventorySwatchesFrontendUi/js/swatch-renderer': true}}}};
        require.config(config);
    })();
    (function () {
        var config = {
    ...
    (function () {
        var config = {
            shim: {'Magento_Tinymce3/tiny_mce/tiny_mce_src': {'exports': 'tinymce'}},
            map: {'*': {'tinymceDeprecated': 'Magento_Tinymce3/tiny_mce/tiny_mce_src'}}
        };
        require.config(config);
    })();
    (function () {
        var config = {
            map: {'*': {mageTranslationDictionary: 'Magento_Translation/js/mage-translation-dictionary'}},
    ...
    (function () {
        var config = {
            ...
            config: {
                mixins: {
                    'Amazon_Payment/js/action/place-order': {'Amazon_Payment/js/model/place-order-mixin': true},
                    'Magento_Tax/js/view/checkout/summary/grand-total': {'Amazon_Payment/js/view/checkout/summary/grand-total-mixin': true}
                }
            }
        };
        require.config(config);
    ...
    (function () {
        var config = {
            ...
            shim: {
                ...
                'internationalTelephoneInput': {'deps': ['jquery', 'intlTelInput']}
            },
            config: {
                mixins: {
                    'mage/validation': {'Dotdigitalgroup_Sms/js/telephoneValidatorAddress': true},
                    'Magento_Ui/js/form/element/abstract': {'Dotdigitalgroup_Sms/js/setAdditionalParams': true},
                    'Magento_Ui/js/lib/validation/validator': {'Dotdigitalgroup_Sms/js/telephoneValidatorCheckout': true}
                }
            }
        };
        require.config(config);
    ...
    (function () {
        var config = {
            config: {mixins: {'Magento_Checkout/js/action/get-payment-information': {'Klarna_Kp/js/action/override': true}}},
    ...
    (function () {
        var config = {
            config: {
                mixins: {
                    'Magento_Checkout/js/model/step-navigator': {'PayPal_Braintree/js/model/step-navigator-mixin': true},
                    'PayPal_Braintree/js/view/payment/method-renderer/cc-form': {'PayPal_Braintree/js/reCaptcha/braintree-cc-method-mixin': true}
                }
    ...
    (function () {
        var config = {
            map: {'*': {braintree: 'https://js.braintreegateway.com/web/3.67.0/js/client.min.js',}},
            paths: {
        ...
        var config = {
            map: {
                '*': {
                    ...
                    'Magento_Customer/template/authentication-popup': 'Rokanthemes_AjaxSuite/templates/authentication-popup',
    ...
    (function () {
        var config = {map: {'*': {'rokanthemes/categorytab': 'Rokanthemes_CategoryTab/js/categorytab'}}};
        require.config(config);
    })();
    (function () {
        var config = {
            "shim": {"rokanthemes/custommenu": ["jquery"]},
            'paths': {'rokanthemes/custommenu': 'Rokanthemes_CustomMenu/js/custommenu'}
        };
        require.config(config);
    })();
    (function () {
        var config = {
            map: {
                '*': {
                    'Magento_Checkout/template/billing-address/form.html': 'Rokanthemes_OnePageCheckout/templates/billing-address/form.html',
                    'Magento_Checkout/js/model/shipping-rate-service': 'Rokanthemes_OnePageCheckout/js/model/shipping-rate-service',
                    'Magento_Checkout/js/action/get-payment-information': 'Rokanthemes_OnePageCheckout/js/action/get-payment-information'
                }
            }, config: {
                mixins: {
                    ...
                    'Magento_Checkout/js/model/step-navigator': {'Rokanthemes_OnePageCheckout/js/model/step-navigator-mixin': true},
                    ...
                    'Magento_Checkout/js/model/shipping-rates-validation-rules': {'Rokanthemes_OnePageCheckout/js/model/shipping-rates-validation-rules-mixin': true},
                    'Magento_Paypal/js/in-context/express-checkout-wrapper': {'Rokanthemes_OnePageCheckout/js/paypal/in-context/express-checkout-wrapper-mixin': true},
                    'Magento_Paypal/js/view/payment/method-renderer/in-context/checkout-express': {'Rokanthemes_OnePageCheckout/js/paypal/view/payment/method-renderer/in-context/checkout-express-mixin': true},
                    'Amazon_Payment/js/view/payment/list': {'Rokanthemes_OnePageCheckout/js/amazon-pay/view/payment-list': true},
                    'Amazon_Payment/js/view/checkout-revert': {'Rokanthemes_OnePageCheckout/js/amazon-pay/view/checkout-revert-rewrite': true}
                }
            }
        };
        require.config(config);
    ...
    (function () {
        var config = {
            ...
            'paths': {
                ...
                'rokanthemes/marquee': 'Rokanthemes_RokanBase/js/jquery.marquee.min.js'
            },
    ...
    (function () {
        var config = {map: {'*': {'rokanthemes/timer': 'Rokanthemes_PriceCountdown/js',},}};
        require.config(config);
    })();
    (function () {
        var config = {map: {'*': {'rokanthemes/producttab': 'Rokanthemes_ProductTab/js/producttab'}}};
        require.config(config);
    })();
    (function () {
        var config = {
    ...
    (function () {
        var config = {
            "shim": {"rokanthemes/nivoSlider": ["jquery"]},
            'paths': {"rokanthemes/nivoSlider": "Rokanthemes_SlideBanner/js/nivoSlider"}
        };
        require.config(config);
    })();
    (function () {
        var config = {
            "shim": {"rokanthemes/timecircles": ["jquery"]},
            'paths': {'rokanthemes/timecircles': 'Rokanthemes_Superdeals/js/timecircles'}
        };
        require.config(config);
    })();
    (function () {
        var config = {
            ...
            'paths': {'rokanthemes/verticalmenu': 'Rokanthemes_VerticalMenu/js/verticalmenu'}
        };
        require.config(config);
    })();
    (function () {
    ...
    (function (b) {
        b.fn.bPopup = function (z, F) {
            ...
            var c = this, g = b(document), y = window, d = b(y), w = y.innerHeight || d.height(),
                u = y.innerWidth || d.width(), M = /OS 6(_\d)+/i.test(navigator.userAgent), C = 200, t = 0, e, B, p, m,
                f, x, v, r, s, I;
            c.close = function () {
                a = this.data("bPopup");
