...
;define('mixins', ['module'], function(module) {
    'use strict';
    var contexts = require.s.contexts, defContextName = '_', defContext = contexts[defContextName], unbundledContext = require.s.newContext('$'), defaultConfig = defContext.config, unbundledConfig = {
...
require(["jquery"], function($) {
    (function(b) {
        b.fn.bPopup = function(z, F) {
            ...
            function A() {
                a.modal && b('<div class="b-model ' + e + '"></div>').css({
            ...
            function q() {
                a.modal && b(".b-model." + c.data("id")).fadeTo(a.speed, 0, function() {
                    b(this).remove()
                });
                a.scrollBar || b("html").css("overflow", "auto");
                b(".b-model." + e).unbind("click");
                g.unbind("keydown." + e);
            ...
            function L() {
                ...
                a.modalClose && b(".b-model." + e).css("cursor", "pointer").bind("click", q);
