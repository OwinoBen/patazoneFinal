...
+ Include `js/bootstrap-modalmanager.js` and `js/bootstrap-modal.js` after the main bootstrap js files.
	...
	<link href="css/bootstrap-responsive.css" rel="stylesheet" />
 	...
 	<script src="../../../js/jsbootstrap/js/js/bootstrap.js"></script>
 	<script src="../../../js/jsbootstrap/js/js/bootstrap-modalmanager.js"></script>
 	<script src="../../../js/jsbootstrap/js/js/bootstrap-modal.js"></script>
