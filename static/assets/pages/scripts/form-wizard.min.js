            ...
            if (jQuery().bootstrapWizard) {
                ...
                r.validate({
                    ...
                    rules: {
                        ...
                        PhoneNumber: {digits: !0,required: !0, minlength: 9, maxlength: 9},
                        gender: {required: !0},
                        organization: {required: !0},
                        bstype: {required: !0},
                        totalEmployess: {required: !0},
                        regNo: {required: !0},
                        regDoc: {required: !0},
                        kra: {required: !0},
                        kraCopy: {required: !0},
                        vat: {required: !0},
                        nationalID: {required: !0},
                        address: {required: !0},
                        idPhoto: {required: !0},
                        shopname: {required: !0},
                        pcategory: {required: !0},
                        productrange: {required: !0},
                        bankbranch: {required: !0},
                        bankcode: {required: !0},
                        accountnumber: {digits: !0, required: !0, minlength: 10, maxlength: 17},
                        accountname: {required: !0},
                        bankname: {required: !0},
                        payment_mode: {required: !0},
                        city: {required: !0},
                        country: {required: !0},
                    ...
                    errorPlacement: function (e, r) {
                        "gender" == r.attr("name") ? e.insertAfter("#form_gender_error") :"vat"==r.attr("name") ? e.insertAfter("#form_vat_error"): "payment[]" == r.attr("name") ? e.insertAfter("#form_payment_error") : e.insertAfter(r)
                    },
                    ...
                    success: function (e) {
                        "gender" == e.attr("for") || "vat" == e.attr("for") ||"payment[]" == e.attr("for") ? (e.closest(".form-group").removeClass("has-error").addClass("has-success"), e.remove()) : e.addClass("valid").closest(".form-group").removeClass("has-error").addClass("has-success")
                    },
