...
urlpatterns = [
    ...
    path('cart/details/', include(("carts.urls", carts), namespace='cart')),
...
if settings.DEBUG:
    ...
    urlpatterns = urlpatterns + static(settings.MEDIA_URL, document_root=settings.DEFAULT_FILE_STORAGE)
